...
func newTodo(db *gorm.DB, opts ...gen.DOOption) todo {
	...
	_todo.todoDo.UseModel(&mysql.Todo{})

	tableName := _todo.todoDo.TableName()
	_todo.ALL = field.NewAsterisk(tableName)
	_todo.ID = field.NewInt64(tableName, "id")
	_todo.CreatedAt = field.NewString(tableName, "created_at")
	_todo.UpdatedAt = field.NewString(tableName, "updated_at")
...
type ITodoDo interface {
	...
	Unscoped() ITodoDo
	Create(values ...*mysql.Todo) error
	CreateInBatches(values []*mysql.Todo, batchSize int) error
	Save(values ...*mysql.Todo) error
	First() (*mysql.Todo, error)
	Take() (*mysql.Todo, error)
	Last() (*mysql.Todo, error)
	Find() ([]*mysql.Todo, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*mysql.Todo, err error)
	FindInBatches(result *[]*mysql.Todo, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*mysql.Todo) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*mysql.Todo, error)
	FirstOrCreate() (*mysql.Todo, error)
	FindByPage(offset int, limit int) (result []*mysql.Todo, count int64, err error)
...
func (t todoDo) Create(values ...*mysql.Todo) error {
	if len(values) == 0 {
		return nil
	}
...
func (t todoDo) CreateInBatches(values []*mysql.Todo, batchSize int) error {
	return t.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (t todoDo) Save(values ...*mysql.Todo) error {
	if len(values) == 0 {
		return nil
	}
...
func (t todoDo) First() (*mysql.Todo, error) {
	if result, err := t.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*mysql.Todo), nil
	}
}

func (t todoDo) Take() (*mysql.Todo, error) {
...
func (t todoDo) Last() (*mysql.Todo, error) {
...
func (t todoDo) Find() ([]*mysql.Todo, error) {
	result, err := t.DO.Find()
	return result.([]*mysql.Todo), err
}

func (t todoDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*mysql.Todo, err error) {
	buf := make([]*mysql.Todo, 0, batchSize)
...
func (t todoDo) FindInBatches(result *[]*mysql.Todo, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (t todoDo) FirstOrInit() (*mysql.Todo, error) {
...
func (t todoDo) FirstOrCreate() (*mysql.Todo, error) {
...
func (t todoDo) FindByPage(offset int, limit int) (result []*mysql.Todo, count int64, err error) {
...
func (t todoDo) Delete(models ...*mysql.Todo) (result gen.ResultInfo, err error) {
